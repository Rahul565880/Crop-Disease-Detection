...
const ALL_MARKETS = {
  Tomato: [
    ...
    { market: 'Gulbarga APMC', price: 26, unit: 'kg', state: 'Karnataka', date: new Date().toISOString().split('T')[0] },
  ...
  Potato: [
    ...
    { market: 'Gulbarga Mandi', price: 19, unit: 'kg', state: 'Karnataka', date: new Date().toISOString().split('T')[0] },
  ],
  Rice: [
    ...
    { market: 'Gulbarga APMC', price: 34, unit: 'kg', state: 'Karnataka', date: new Date().toISOString().split('T')[0] },
  ],
  Wheat: [
  ...
  Cotton: [
    ...
    { market: 'Gulbarga Cotton Yard', price: 59, unit: 'kg', state: 'Karnataka', date: new Date().toISOString().split('T')[0] },
  ],
  Chilli: [
