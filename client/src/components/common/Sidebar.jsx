  ...
  return (
    <>
      <button data-sidebar-toggle onClick={() => setOpen(true)} style={{
        ...
        padding: '8px 10px', borderRadius: '0 8px 8px 0', fontSize: '1.2rem',
      ...
      {open && (
        <div data-sidebar style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', borderBottom: '1px solid #2d5a2d' }}>
